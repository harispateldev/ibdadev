...
const capabilities = [
  ...
  {
    title: "3D Animation",
    desc: "We build cinematic 3D assets designed to give your brand a premium feel. Motion graphics and renders that elevate every touchpoint.",
...
export const CapabilitiesStacked = () => {
  ...
  return (
    <section ref={containerRef} className="relative bg-refract-bg overflow-hidden py-40">
      ...
      <div className="flex flex-col gap-0">
        {capabilities.map((cap, i) => (
          ...
          >
            <div 
              className="w-[90%] md:w-[85%] h-[80vh] bg-refract-surface border border-white/5 bg-black rounded-[48px] overflow-hidden flex flex-col md:flex-row shadow-2xl relative"
            >
              {/* Image Side */}
              <div className="w-full md:w-1/2 h-1/2 md:h-full relative overflow-hidden bg-black/20">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-r from-refract-surface via-transparent to-transparent hidden md:block" />
              </div>
